    ...
    <div class="table-wrapper">
        <table border="1" cellpadding="10" cellspacing="0">
            ...
            <tr>
                ...
                <td>
                   <a href="editpengguna.php?id=<?= $row['id_pengguna'] ?>" class="btn btn-warning">
    <i class="fas fa-pencil-alt"></i>
</a>
<?php if ($role == 'Admin'): ?>
    <a href="hapuspengguna.php?id=<?= $row['id_pengguna'] ?>" onclick="return confirm('Yakin ingin menghapus?')" class="btn btn-danger">
